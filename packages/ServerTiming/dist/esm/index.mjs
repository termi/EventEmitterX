...
import { isIDEDebugger } from "termi@runEnv";
import { TimeMark } from "./TimeMark.mjs";
...
const _debug_toLocaleTimeString_options = isIDEDebugger
...
class ServerTiming {
    ...
    time(timerName, displayName) {
        ...
        this._timeMarksMap.set(timerName, new TimeMark(timerName, {
            __proto__: null,
            data: {
                depth: this.depth,
...
export function parseServerTimingsString(serverTimingsString) {
    const result = [];
