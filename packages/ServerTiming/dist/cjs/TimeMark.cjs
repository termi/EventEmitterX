...
exports.TimeMark = exports.kTimeMarkSetDuration = void 0;
const SECONDS = 1000;
...
exports.kTimeMarkSetDuration = Symbol('kTimeMarkSetDuration');
class TimeMark {
    /**
     ...
     */
    [exports.kTimeMarkSetDuration](newTestDuration) {
        const performance = this._perf;
