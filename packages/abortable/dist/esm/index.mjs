...
export class AbortControllersGroup extends _AbortControllerClass {
    /**
...
export class AbortControllerProxy {
    /**
     * @example
...
export class RemoteAbortController extends _AbortControllerClass {
...
export function isAbortSignal(maybeAbortSignal) {
...
export function isAbortController(maybeAbortController) {
...
export function isAbortControllersGroup(maybeAbortControllersGroup) {
...
export const errorFabric = (function () {
 ...
 */
export function createAbortError(code, cause) {
    ...
    return errorFabric('The operation was aborted', tagAbortError, code, cause);
}
...
function _createTimeoutError(code, cause) {
    ...
    return errorFabric('The operation timed out.', tagTimeoutError, code, cause);
}
/*
 ...
 */
export const isAbortedError = isAbortError;
/**
 * @see [MDN / DOMException]{@link https://developer.mozilla.org/en-US/docs/Web/API/DOMException}
 */
