...
export declare class AbortControllersGroup extends _AbortControllerClass {
     ...
     */
    constructor(controllers: (AbortController | undefined)[], signals?: (AbortSignal | undefined)[], spreadAbortCall?: boolean, spreadOnAborted?: boolean);
 ...
 */
export declare function createAbortError(code?: number | string, cause?: any): DOMException | (Error & {
    originalStack?: any;
});
/**
