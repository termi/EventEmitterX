'use strict';
import '../../../polyfills/dist/esm/Symbol.mjs';
import { displayValueForTypeGuard } from "./type_guards_utils.mjs";
export function isSymbol(value) {
    return typeof value === 'symbol';
}
export function assertIsSymbol(value) {
...
export function assertIsRegisteredSymbol(value) {
    const type = typeof value;
...
export function isWellKnownSymbol(value) {
    return typeof value === 'symbol' && _Symbol_isWellKnown(value);
}
export function assertIsWellKnownSymbol(value) {
    const type = typeof value;
...
export function isUniqueSymbol(value) {
    return typeof value === 'symbol'
        && !_Symbol_isRegistered(value)
        && !_Symbol_isWellKnown(value);
}
export function assertIsUniqueSymbol(value) {
    const type = typeof value;
