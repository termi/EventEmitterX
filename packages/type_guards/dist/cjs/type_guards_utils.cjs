...
exports.displayValueForTypeGuard = displayValueForTypeGuard;
exports.primitiveValueToStringForTypeGuard = primitiveValueToStringForTypeGuard;
/** @private */
const _is = Object.is;
function displayValueForTypeGuard(value, type = typeof value, options) {
...
function primitiveValueToStringForTypeGuard(value, type = typeof value, options) {
