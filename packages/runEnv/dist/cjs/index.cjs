...
exports.envDetails = exports.envDetailsFull = exports.isIDEDebugger = exports.isVSCodeDebugger = exports.isWebStormDebugger = exports.isTest = exports.isDev = exports.isJSDOM = exports.isReactNative = exports.isMultiTouchDevice = exports.isTouchDevice = exports.isElectronNodeIntegration = exports.isElectronRendererPreload = exports.isElectronRenderer = exports.isElectronMain = exports.isElectron = exports.isNWJSMixedContextWindow = exports.isCordova = exports.isWebAudioWorklet = exports.isWebPaintWorklet = exports.isWebWorklet = exports.isWebServiceWorker = exports.isWebSharedWorker = exports.isWebDedicatedWorker = exports.isWebWorker = exports.isWebDependentWindow = exports.isWebMainThread = exports.isWeb = exports.isWebWorkerThreadCompatible = exports.isWebMainThreadCompatible = exports.isBunWorker = exports.isBunMainThread = exports.isBun = exports.isDenoWorkerWithImportScripts = exports.isDenoWorker = exports.isDenoMainThread = exports.isDeno = exports.isNodeJSWorker = exports.isNodeJSDependentProcess = exports.isNodeJSMainThread = exports.isNodeJS = exports.isWorkerThread = exports.isMainThread = void 0;
 ...
 */
exports.isMainThread = ENVIRONMENT_IS_MAIN_THREAD;
/**
 ...
 */
exports.isWorkerThread = ENVIRONMENT_IS_WORKER_OR_WORKLED_THREAD;
// -----------============================== NodeJS details ==============================-----------
/**
 ...
 */
exports.isNodeJS = ENVIRONMENT_IS_NODE;
/**
 ...
 */
exports.isNodeJSMainThread = ENVIRONMENT_IS_NODE && ENVIRONMENT_IS_NODE_MAIN_THREAD;
 ...
 * @see [isNodeJSMainThread]{@link isNodeJSMainThread}
 */
exports.isNodeJSDependentProcess = ENVIRONMENT_IS_NODE
    && _IS_PROCESS
    && !!nodeProcess.send
 ...
 */
exports.isNodeJSWorker = ENVIRONMENT_IS_NODE && !ENVIRONMENT_IS_NODE_MAIN_THREAD;
// -----------============================== Deno details ==============================-----------
/**
 ...
 */
exports.isDeno = ENVIRONMENT_IS_DENO;
/**
 * Is Deno main thread.
 *
 ...
 * }
 */
exports.isDenoMainThread = ENVIRONMENT_IS_DENO
    && !ENVIRONMENT_IS_WEB_WORKER_COMPATIBLE;
/**
 ...
 * }
 */
exports.isDenoWorker = ENVIRONMENT_IS_DENO
    && ENVIRONMENT_IS_WEB_WORKER_COMPATIBLE;
/**
 ...
 * @see [Using the "lib" property / "webworker.importscripts"]{@link https://docs.deno.com/runtime/manual/advanced/typescript/configuration#using-the-lib-property}
 */
exports.isDenoWorkerWithImportScripts = ENVIRONMENT_IS_DENO
    && ENVIRONMENT_IS_WEB_WORKER_COMPATIBLE
 ...
 */
exports.isBun = ENVIRONMENT_IS_BUN;
/**
 * Is Bun main thread.
 *
 ...
 * }
 */
exports.isBunMainThread = ENVIRONMENT_IS_BUN
    && !ENVIRONMENT_IS_WEB_WORKER_COMPATIBLE
    && ENVIRONMENT_IS_NODE_MAIN_THREAD;
/**
 ...
 * }
 */
exports.isBunWorker = ENVIRONMENT_IS_BUN
    // Bun Worker is NOT a Web-like WebWorker compatible, but more like NodeJS Workers
    && !ENVIRONMENT_IS_NODE_MAIN_THREAD;
// -----------============================== Web details ==============================-----------
/**
 ...
 */
exports.isWebMainThreadCompatible = ENVIRONMENT_IS_WEB_MAIN_PROCESS_COMPATIBLE;
/**
 ...
 */
exports.isWebWorkerThreadCompatible = ENVIRONMENT_IS_WEB_WORKER_COMPATIBLE;
/**
 ...
 */
exports.isWeb = ENVIRONMENT_IS_WEB;
/**
 ...
 * @see [isWebDependentWindow]{@link isWebDependentWindow}
 */
exports.isWebMainThread = ENVIRONMENT_IS_WEB && ENVIRONMENT_IS_MAIN_THREAD;
/**
 ...
 */
exports.isWebDependentWindow = ENVIRONMENT_IS_WEB && ENVIRONMENT_IS_MAIN_THREAD
    && !!window.opener;
/**
 ...
 */
exports.isWebWorker = ENVIRONMENT_IS_WEB_WORKER;
/**
 ...
 * @see [MDN / Using web workers]{@link https://developer.mozilla.org/en-US/docs/Web/API/Web_Workers_API/Using_web_workers}
 */
exports.isWebDedicatedWorker = ENVIRONMENT_IS_WEB_WORKER
    // see node_modules/typescript/lib/lib.webworker.d.ts
    /** @see [DedicatedWorkerGlobalScope]{@link import("typescript/lib/lib.webworker").DedicatedWorkerGlobalScope} */
    // eslint-disable-next-line @typescript-eslint/ban-ts-comment,@typescript-eslint/prefer-ts-expect-error
 ...
 */
exports.isWebSharedWorker = ENVIRONMENT_IS_WEB_WORKER
    // see node_modules/typescript/lib/lib.webworker.d.ts
 ...
 * @see [MDN / Using web workers]{@link https://developer.mozilla.org/en-US/docs/Web/API/Web_Workers_API/Using_web_workers}
 */
exports.isWebServiceWorker = ENVIRONMENT_IS_WEB_WORKER
    // see node_modules/typescript/lib/lib.webworker.d.ts
 ...
 */
exports.isWebWorklet = ENVIRONMENT_IS_WEB_WORKLED;
/**
 ...
 */
exports.isWebPaintWorklet = ENVIRONMENT_IS_WEB_WORKLED
 ...
 */
exports.isWebAudioWorklet = ENVIRONMENT_IS_WEB_WORKLED
    // eslint-disable-next-line @typescript-eslint/ban-ts-comment
    // @ts-expect-error
 ...
 * }
 */
exports.isNWJSMixedContextWindow = ENVIRONMENT_IS_NWJS;
 ...
 **/
exports.isElectron = ENVIRONMENT_IS_ELECTRON;
/**
 ...
 **/
exports.isElectronMain = ELECTRON_ENV === ELECTRON__MAIN;
/**
 ...
 * @see [electronjs/docs/Quick Start]{@link https://www.electronjs.org/docs/latest/tutorial/quick-start}
 **/
exports.isElectronRenderer = ELECTRON_ENV === ELECTRON__RENDERER_WITH_NODE_INTEGRATION
 ...
 */
exports.isElectronRendererPreload = ELECTRON_ENV === ELECTRON__RENDERER_WITH_NODE_INTEGRATION
    && !ENVIRONMENT_IS_WEB
    && _toString.call(window) === '[object global]';
/**
 ...
 */
exports.isElectronNodeIntegration = ENVIRONMENT_IS_ELECTRON
 ...
 */
exports.isTouchDevice = ENVIRONMENT_IS_TOUCH_DEVICE;
/**
 ...
 * @see [Touch events]{@link https://developer.mozilla.org/en-US/docs/Web/API/Touch_events}
 */
exports.isMultiTouchDevice = ENVIRONMENT_IS_MULTI_TOUCH_DEVICE;
// -----------============================== ReactNative details ==============================-----------
/**
 * Is running in [ReactNative]{@link https://reactnative.dev/} environment?
 */
exports.isReactNative = ENVIRONMENT_IS_REACT_NATIVE;
// -----------============================== JSDOM details ==============================-----------
/**
 ...
 */
exports.isIDEDebugger = IS_WEB_STORM_DEBUGGER || IS_VSCODE_INSPECTOR;
// -----------============================== Some detailed info (can be used for debug) ==============================-----------
const _envDetailsFull = {
    isMainThread: exports.isMainThread,
    isWorkerThread: exports.isWorkerThread,
    isNodeJS: exports.isNodeJS,
    isNodeJSMainThread: exports.isNodeJSMainThread,
    isNodeJSDependentProcess: exports.isNodeJSDependentProcess,
    isNodeJSWorker: exports.isNodeJSWorker,
    isDeno: exports.isDeno,
    isDenoMainThread: exports.isDenoMainThread,
    isDenoWorker: exports.isDenoWorker,
    isDenoWorkerWithImportScripts: exports.isDenoWorkerWithImportScripts,
    isBun: exports.isBun,
    isBunMainThread: exports.isBunMainThread,
    isBunWorker: exports.isBunWorker,
    isWeb: exports.isWeb,
    isWebMainThread: exports.isWebMainThread,
    isWebMainThreadCompatible: exports.isWebMainThreadCompatible,
    isWebWorkerThreadCompatible: exports.isWebWorkerThreadCompatible,
    isWebDependentWindow: exports.isWebDependentWindow,
    isWebWorker: exports.isWebWorker,
    isWebDedicatedWorker: exports.isWebDedicatedWorker,
    isWebSharedWorker: exports.isWebSharedWorker,
    isWebServiceWorker: exports.isWebServiceWorker,
    isWebWorklet: exports.isWebWorklet,
    isWebPaintWorklet: exports.isWebPaintWorklet,
    isWebAudioWorklet: exports.isWebAudioWorklet,
    isCordova: exports.isCordova,
    isNWJSMixedContextWindow: exports.isNWJSMixedContextWindow,
    isElectron: exports.isElectron,
    isElectronMain: exports.isElectronMain,
    isElectronRenderer: exports.isElectronRenderer,
    isElectronRendererPreload: exports.isElectronRendererPreload,
    isElectronNodeIntegration: exports.isElectronNodeIntegration,
    isTouchDevice: exports.isTouchDevice,
    isMultiTouchDevice: exports.isMultiTouchDevice,
    isReactNative: exports.isReactNative,
    isJSDOM: exports.isJSDOM,
    isDev: exports.isDev,
    isTest: exports.isTest,
    isWebStormDebugger: exports.isWebStormDebugger,
    isVSCodeDebugger: exports.isVSCodeDebugger,
    isIDEDebugger: exports.isIDEDebugger,
};
