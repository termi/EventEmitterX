...
if (!_Map_prototype.getOrInsert) {
    defineMethodProperty(_Map_prototype, 'getOrInsert', function getOrInsert(key, defaultValue) {
...
if (!_Map_prototype.getOrInsertComputed) {
    defineMethodProperty(_Map_prototype, 'getOrInsertComputed', function getOrInsertComputed(key, computation) {
        if (_Map_prototype_has.call(this, key)) {
            return _Map_prototype_get.call(this, key);
        }
...
if (!Map.groupBy) {
    defineMethodProperty(Map, 'groupBy', function (iterable, predicate) {
